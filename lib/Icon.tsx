...
export const PasswordIcon = (props: IconProps) => {
  return (
    <svg width={props.size || props.width || 24} height={props.size || props.height || 24} viewBox='0 0 24 24'>
...
export const MailIcon = (props: IconProps) => {
  return (
    <svg width={props.size || props.width || 24} height={props.size || props.height || 24} viewBox='0 0 24 24'>
      <g fill='none' stroke={props.fillColor} strokeLinecap='round' strokeLinejoin='round' strokeWidth={1.5}>
